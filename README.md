...
8. 如需按键操作，点击“按键操作”，在弹出的窗口里直接按下目标按键或组合键，再设置延迟时间和超时时间。
9. 在动作列表里，可以点击缩略图查看大图，也可以直接点击“延迟时间”或“超时时间”修改。
10. 拖动任务条可以调整执行顺序；右键某一步可以修改内容或单独删除。
11. 调整循环次数、播放速度后，点击“全局保存”。
12. 点击“开始回放”执行脚本。
